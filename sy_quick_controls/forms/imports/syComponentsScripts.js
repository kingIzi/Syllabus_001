...
function getMaterialColorCodesListModel(){
    var colorCodes = []
    for (let key in SyConstants.materialColorCodes){
        const code = SyConstants.materialColorCodes[key]
...
function getMaterialShade(modelData,count,Material){
    ...
    case 3:
        return Material.color(modelData)
    default:
