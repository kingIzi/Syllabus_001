...
Rectangle{
    ...
    function openBook(filename){
        const page = Qt.createComponent(filename,parent)
        const pageObject = page.createObject(parent,{})
        homeStackView.push(pageObject)
    }

//    function onPosterClicked(){
//        const page = Qt.createComponent("qrc:/forms/qml/components/SyPosterDetails.qml",parent)
//        const pageObject = page.createObject(parent,{"poster":syPoster.posterData})
//        homeStackView.push(pageObject)
//    }
